...
const Hero = () => {
  return (
    <div className='flex items-center flex-col mt-20'>
        <div>
            <h2 className='text-3xl font-bold'>learn smarter with <span className='text-primary'>AI  Video Course</span></h2>
      ...
      <InputGroup>
        <InputGroupTextarea
          ...
          className="flex field-sizing-content min-h-24 w-full resize-none rounded-xl  px-3 py-2.5 bg-white text-base transition-[color,box-shadow] outline-none md:text-sm"
...
<Select>
 ...
 <InputGroupButton className="ml-auto" size="icon-sm" variant="default">
    ...
    <div className='flex gap-5 mt-10 max-w-3xl flex-wrap justify-center'>
